...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 x1:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover h-screen'>
